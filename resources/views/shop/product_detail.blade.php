...
@section('meta_title',$product->meta_title) @section('meta_description',$product->meta_description)
...
@section('content')
                 ...
                 <div class="col-xl-10">
                    <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                       <div class="bd-breadcrumb-content text-center">
                          <h1 class="bd-breadcrumb-title">Product Details</h1>
     ...
     <section class="shop-details-area pt-120 pb-90">
        @livewire('parent.add-to-cart-detail-component',['product'=>$product,'productId'=>$product->id])
     </section>
